...
public class Pago {
    ...
    private String compraId;            // referencia al id de compra (en el otro servicio)
    private Double monto;
    private MedioPago medio;
    private EstadoPago estado;
    private String referenciaPasarela;  // id externo simulado/real
    private String urlRedireccion;      // si la pasarela requiere checkout
